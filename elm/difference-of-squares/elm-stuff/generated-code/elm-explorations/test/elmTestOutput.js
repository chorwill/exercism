...
var author$project$DifferenceOfSquares$sqr = function (x) {
	return x * x;
};
...
var author$project$DifferenceOfSquares$squareOfSum = function (n) {
	return author$project$DifferenceOfSquares$sqr(
		elm$core$List$sum(
...
var author$project$DifferenceOfSquares$sumOfSquares = function (n) {
	return elm$core$List$sum(
		A2(
			elm$core$List$map,
			author$project$DifferenceOfSquares$sqr,
			A2(elm$core$List$range, 1, n)));
};
...
var author$project$Test$Generated$Main276296042$main = A2(
	author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['C:\\Users\\chris\\exercism\\elm\\difference-of-squares\\tests\\Tests.elm']),
		processes: 12,
		report: author$project$Test$Reporter$Reporter$ConsoleReport(author$project$Console$Text$UseColor),
		runs: elm$core$Maybe$Nothing,
		seed: 403383912552141
	},
...
_Platform_export({'Test':{'Generated':{'Main276296042':{'init':author$project$Test$Generated$Main276296042$main(elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-18724-1";
